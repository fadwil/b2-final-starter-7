...
RSpec.describe "bulk discounts index" do
  before :each do
    ...
    @bulk1 = @merchant1.bulk_discounts.create!(percentage_discount: 10, quantity_threshold: 20 )
  ...
  it "each discount is a link to its show page" do
    within "#bulk-#{@bulk1.id}" do
      expect(page).to have_link(@bulk1.percentage_discount)
  ...
  # Story 3
  it "next to each bulk discount I see a link to delete it, when clicked I am redirected to the index and no longer see the discount" do
    within "#bulk-#{@bulk1.id}" do
